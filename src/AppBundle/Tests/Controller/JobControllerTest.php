...
class JobControllerTest extends WebTestCase
{
    ...
    public function getExpiredJob()
    {
        ...
        $query = $em->createQuery('SELECT j from AppBundle:Job j WHERE j.expiresAt < :date');
        $query->setParameter('date', date('Y-m-d H:i:s', time()));
        $query->setMaxResults(1);
        return $query->getSingleResult();
    }
...
//    }
    ...
    public function testJobForm()
    {
        ...
        $this->assertEquals('AppBundle\Controller\JobController::newAction', $client->getRequest()
        ...
        $this->assertEquals('AppBundle\Controller\JobController::previewAction', $client->getRequest()
            ->attributes->get('_controller'));
